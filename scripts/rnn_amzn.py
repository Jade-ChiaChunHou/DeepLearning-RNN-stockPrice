...
# training set
stock_train = yf.download("AMZN", "2014-01-02", "2019-08-30")
del stock_train['Adj Close']
stock_train.head()
stock_train.to_csv("amazon_train_2019.csv")


# testset
stock_test = yf.download("AMZN", "2019-09-01", "2019-10-07")
del stock_test['Adj Close']
stock_test.head()
stock_test.to_csv("amazon_test_2019.csv")
...
dataset_train = pd.read_csv('amazon_train_2019.csv')
...
dataset_test = pd.read_csv('amazon_test_2019.csv')
...
fig.savefig('amzn_50_100_150_200.png', dpi=fig.dpi)
