...
# training set
stock_train = yf.download("BRK-A", "2014-01-02", "2019-08-30")
del stock_train['Adj Close']
stock_train.head()
stock_train.to_csv("BRKA_train_2019.csv")


# testset
stock_test = yf.download("BRK-A", "2019-09-01", "2019-10-07")
del stock_test['Adj Close']
stock_test.head()
stock_test.to_csv("BRKA_test_2019.csv")
...
dataset_train = pd.read_csv('BRKA_train_2019.csv')
...
dataset_test = pd.read_csv('BRKA_test_2019.csv')
...
plt.title('BRK-A Stock Price Prediction')
plt.xlabel('Time')
plt.ylabel('Stock Price')
plt.legend()
plt.show()

fig.savefig('BRKA_201909_50_100_150_200.png', dpi=fig.dpi)
