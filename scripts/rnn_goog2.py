...
# testset
stock_test = yf.download("GOOG", "2019-09-01", "2019-10-07")
...
# Fitting the RNN to the Training set
regressor3.fit(X_train, y_train, epochs = 150, batch_size = 16)
...
# Fitting the RNN to the Training set
regressor4.fit(X_train, y_train, epochs = 200, batch_size = 16)
...
fig.savefig('goog_batch16_201909_50_100_150_200.png', dpi=fig.dpi)
