...
stock_train.to_csv("google_train_201910.csv")
...
dataset_train = pd.read_csv('google_train_201910.csv')
...
fig.savefig('goog_pred_201909_50_100_150_200.png', dpi=fig.dpi)
